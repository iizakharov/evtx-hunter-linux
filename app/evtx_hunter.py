...
def main():
    ...
    logger.info("started sc-evtx-parser")

    vars.PROJECT_ROOT_DIR = os.path.dirname(os.path.abspath(__file__)).split('/app')[0]
    ...
    vars.DASH_APP.title = "sc-evtx-parser"
    ...
    # comment for static dir  <----
    # evtxloader = EvtxLoader(vars.PROJECT_ROOT_DIR + '/logs/one/')
    ...
    children = [
        html.Hr(),
        html.H1(children='sc-evtx-parser'),
